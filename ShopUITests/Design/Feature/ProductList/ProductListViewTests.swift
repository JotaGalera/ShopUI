...
class ProductListViewTests: XCTestCase {
    func testProductListView() {
        let productMock = Product(name: "nameMock", color: "", brand: "brandMock", price: 1.0, originalPrice: 0.0, discount: 0.0, totalPrice: 0.0, currency: "currencyMock", image: "imageMock", detailsImages: [""])
